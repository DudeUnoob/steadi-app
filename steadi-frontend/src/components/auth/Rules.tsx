...
export default function RulesPage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            // Extract and set the organization ID if it was auto-generated
            const data = await response.json();
            if (data.organization_id && (!organizationId || organizationId.trim() === '')) {
                setOrganizationId(data.organization_id.toString());
            }
            ...
            toast({
                ...
                description: organizationId 
                    ...
                    : `Role permissions saved with organization ID: ${data.organization_id}`,
            });
